...
describe('getBoard', () => {
  ...
  it(`should return ${chalk.green(200)} and render post/index page if ${chalk.blue('data is not exists')}`, async () => {
  ...
  it(`should return ${chalk.green(200)} and render post/index page with error message if ${chalk.blue('page over 1000')}`, async () => {
  ...
  it(`should return ${chalk.green(200)} and render post/index page with error message if ${chalk.blue('limit query wrong')}`, async () => {
  ...
  it(`should return ${chalk.green(200)} and render post/index page if ${chalk.blue('search successful')}`, async () => {
